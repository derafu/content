 ...
 * Plugin for FAQ.
 */
class FaqPlugin extends AbstractContentPlugin implements ContentPluginInterface
{
    /**
    ...
    private const OPTIONS_SCHEMA = [
        ...
        // Path to the FAQ content directory on the filesystem, relative to
        // website root.
        'path' => [
            'types' => 'string',
            'required' => true,
            'default' => 'resources/content/faq',
        ],

        // Array of glob patterns to include in the faq content relative to
        // the path option.
        'include' => [
            'types' => 'array',
            'required' => true,
        ...
        // Array of glob patterns to exclude in the faq content relative to
        // the path option.
        'exclude' => [
            'types' => 'array',
            'required' => true,
        ...
        // Array of predefined tags to include in the FAQ content.
        'tags' => [
            'types' => ['array', 'string'],
            'required' => true,
            'default' => [],
     ...
     * Registry of the FAQ.
     *
     * @var FaqRegistryInterface
     */
    private FaqRegistryInterface $registry;
     ...
     * {@inheritDoc}
     */
    public function registry(): FaqRegistryInterface
    {
